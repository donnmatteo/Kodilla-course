...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://donnmatteo.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("synaptic92@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Kodilla1123");
    ...
    public void deleteCrudAppTask(String taskName) throws InterruptedException {
        driver.findElements(By.xpath("//form[@class=\"datable_row\"]")).stream()
                ...
                .forEach(theForm -> {
                    WebElement buttonDelete = theForm.findElement(By.xpath
                            (".//div[@class=\"datatable__row-section-wrapper\"]/fieldset[1]/button[4]"));
                    buttonDelete.click();
                });
    }
