...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandOf0Books() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("First name", "Last name", "9192");
        List<Book> listWithoutBooks = new ArrayList<>();
        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(listWithoutBooks);

        //When
        List<Book> testList = bookLibrary.listBooksInHandsOf(user1);
    ...
    @Test
    public void testListBooksInHandOf5Book() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("First name", "Last name", "9192");
